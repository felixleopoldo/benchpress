...
You can easily use your own algorithm in Benchpress regardless of the programming language. To get 

`$ snakemake --cores all new_alg`

This will copy the boilerplate structure learning module called *alg_module* from [resources/boilerplater](resouurces/alg_module) to [workflow/scripts/structure_learning_algorithms/](workflow/scripts/structure_learning_algorithms/).
To get the idea, perhaps the best way to start is to first use and alter the template R-script [script.R](workflow/scripts/structure_learning_algorithms/mylib_myalg.R) as you like. It looks like this at the moment:
