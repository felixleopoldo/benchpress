# structure_learning_algorithms Schema
...
*   Type: `object[]` ([trilearn_pgibbs item](config-definitions-trilearn_pgibbs-item.md))
...
*   Type: `object[]` ([tetrad_fges item](config-definitions-tetrad_fges-item.md))
...
*   Type: `object[]` ([tetrad_fci item](config-definitions-tetrad_fci-item.md))
...
*   Type: `object[]` ([tetrad_rfci item](config-definitions-tetrad_rfci-item.md))
...
*   Type: `object[]` ([tetrad_gfci item](config-definitions-tetrad_gfci-item.md))
...
*   Type: `object[]` ([pcalg_pc item](config-definitions-pcalg_pc-item.md))
...
*   Type: `object[]` ([bnlearn_mmhc item](config-definitions-bnlearn_mmhc-item.md))
...
*   Type: `object[]` ([bnlearn_tabu item](config-definitions-bnlearn_tabu-item.md))
...
*   Type: `object[]` ([bidag_itsearch item](config-definitions-bidag_itsearch-item.md))
...
*   Type: `object[]` ([bidag_order_mcmc item](config-definitions-bidag_order_mcmc-item.md))
...
*   Type: `object[]` ([bnlearn_hc item](config-definitions-bnlearn_hc-item.md))
...
*   Type: `object[]` ([gt13\_multipair item](config-definitions-gt13\_multipair-item.md))

*   cannot be null

*   defined in: [JSON schema for Benchpress config file.](config-properties-resources-properties-structure_learning_algorithms-properties-gt13\_multipair.md "http://github.com/felixleopoldo/benchpress/workflow/schemas/config.schema.json#/properties/resources/properties/structure_learning_algorithms/properties/gt13\_multipair")
...
*   Type: `object[]` ([gg99\_singlepair item](config-definitions-gg99\_singlepair-item.md))

*   cannot be null

*   defined in: [JSON schema for Benchpress config file.](config-properties-resources-properties-structure_learning_algorithms-properties-gg99\_singlepair.md "http://github.com/felixleopoldo/benchpress/workflow/schemas/config.schema.json#/properties/resources/properties/structure_learning_algorithms/properties/gg99\_singlepair")
...
*   Type: `object[]` ([sklearn_glasso item](config-definitions-sklearn_glasso-item.md))
