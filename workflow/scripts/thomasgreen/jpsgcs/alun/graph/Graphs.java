...
public class Graphs
{
	...
	{
//System.err.println("TEST 1\t"+g.getVertices().equals(h.getVertices()));
//System.err.println("TEST 2\t"+h.getVertices().equals(g.getVertices()));
//System.err.println(g.getVertices());
//System.err.println(h.getVertices());
...
System.err.println("\t"+g.inNeighbours(v));
System.err.println("\t"+h.inNeighbours(v));
System.err.println("\t"+g.outNeighbours(v));
System.err.println("\t"+h.outNeighbours(v));
*/
			if (g.isDirected())
			{
	...
	{
		//return triangulate(g, new LinkedHashSet<V>());
